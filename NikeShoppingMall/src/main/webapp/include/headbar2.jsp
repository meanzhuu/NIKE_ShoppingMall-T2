...
<div>
	...
	<div class="row">
		...
		<button style="margin-top:30px;color:#848484;font-weight:bold; border:none; border-right:2px solid #a6a6a6; padding-right:20px;">WOMEN</button>
		<button style="margin-top:30px;color:#848484;font-weight:bold; border:none; padding-left:20px;">MEN</button>
		</div>
		<div class="col-6">
